//Tue Oct 01 2024 09:04:54 GMT+0000 (Coordinated Universal Time)
//Base:https://github.com/echo094/decode-js
//Modify:https://github.com/smallfawn/decode_action
const _0x2a114d = new Env("Eric为你提供服务");
let _0x58eedd = $request.url;
try {
  const _0x3f8a6b = _0x2a114d.getdata("scheme");
  if (!_0x3f8a6b) throw new Error("未能获取到 Scheme，请在 BoxJS 中进行配置。");
  const _0x5c68a4 = _0x2a114d.getdata("capturedUrl");
  (!_0x5c68a4 || _0x5c68a4 !== _0x58eedd) && (_0x2a114d.setdata(_0x58eedd, "capturedUrl"), _0x2a114d.msg("Eric以为你成功捕获视频", "本通知使用自定义浏览器", "点击自定义浏览器观看", {
    "open-url": _0x3f8a6b + "://x-callback-url/play?url=" + _0x58eedd
  }));
} catch (_0x154399) {
  console.error("An error occurred while capturing the URL:", _0x154399);
}
_0x2a114d.done({
  "url": _0x58eedd
});
